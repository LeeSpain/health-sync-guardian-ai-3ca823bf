...
const Hero: React.FC = () => {
  return (
    <section className="relative overflow-hidden pt-10 pb-20 sm:pb-32">
      {/* Background elements */}
      <div className="absolute inset-0 bg-gradient-to-br from-brand-teal/90 to-brand-teal/80 z-0" />
      <div 
        className="absolute inset-0 bg-[url('/grid-pattern.svg')] bg-center opacity-10 z-0"
      />
      <div 
        className="absolute top-0 right-0 w-2/3 h-full bg-white/5 rounded-bl-[100px] z-0 backdrop-blur-[2px]"
      />
      <div 
        className="absolute bottom-0 left-0 w-1/2 h-1/2 bg-white/5 rounded-tr-[100px] z-0 backdrop-blur-[2px]"
      />
      <div 
        className="absolute right-20 top-20 w-64 h-64 rounded-full bg-brand-orange/20 filter blur-3xl z-0"
      />
      <div 
        className="absolute left-10 bottom-20 w-72 h-72 rounded-full bg-white/10 filter blur-3xl z-0"
      />
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="flex flex-col lg:flex-row items-center gap-12">
          ...
          <div className="lg:w-1/2 text-left lg:pr-10">
            ...
            <h1 className="text-white mb-6 leading-tight font-bold tracking-tight">
            ...
            <div className="flex flex-wrap gap-4 mb-8">
              <Button 
                size="lg" 
                className="bg-white text-brand-teal hover:bg-white/90 text-lg px-8 py-6 shadow-lg group rounded-full"
              >
              ...
              <Button 
                size="lg" 
                variant="outline" 
                className="border-white/50 text-white hover:bg-white/10 text-lg px-8 py-6 backdrop-blur-sm rounded-full"
              >
                Explore Solutions
              </Button>
            </div>
          ...
          <div className="lg:w-1/2 relative">
            <div className="relative bg-white/10 backdrop-blur-md rounded-2xl p-6 border border-white/20 shadow-xl">
              ...
              {/* Mockup dashboard */}
              <div className="bg-gray-900/80 rounded-lg overflow-hidden shadow-inner">
                <div className="bg-gray-800 px-4 py-2 flex items-center gap-2">
                  <div className="w-3 h-3 rounded-full bg-red-500"></div>
                  <div className="w-3 h-3 rounded-full bg-yellow-500"></div>
                  <div className="w-3 h-3 rounded-full bg-green-500"></div>
                  <div className="text-white/60 text-xs ml-2">iHealth-Sync Dashboard</div>
                </div>
              ...
              {/* Decorative elements */}
              <div className="absolute -bottom-3 -left-3 w-6 h-6 bg-white/30 rounded-full backdrop-blur-md"></div>
              <div className="absolute top-1/2 -right-3 w-6 h-6 bg-brand-orange/30 rounded-full backdrop-blur-md"></div>
            </div>
            
            {/* Floating devices */}
            <div className="absolute -top-6 -left-6 bg-white/10 backdrop-blur-sm p-3 rounded-xl border border-white/20 shadow-lg transform rotate-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 mt-12">
          {[
            ...
            <div 
              key={index} 
              className="bg-white/10 backdrop-blur-sm rounded-xl p-5 border border-white/10 hover:border-white/30 transition-all duration-300 hover:shadow-lg group"
            >
              <div className="flex items-center gap-4">
                <div className="bg-white/10 rounded-lg p-3 group-hover:bg-brand-orange/20 transition-colors">
                  {feature.icon}
                </div>
                <div>
